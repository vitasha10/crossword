...
<head>
    <meta charset="UTF-8">
    <title>Кроссворд "Графическая информация и компьютер"</title>
...
<body>
    <h1>Кроссворд "Графическая информация и компьютер"</h1>
    <h3 style="margin-top: -1em;">Виталий Сухоплечев</h3>
...
<script>
	...
	CrosswordHeight = 14;
	Words = 10;
	WordLength = new Array(10, 9, 13, 6, 7, 13, 7, 9, 7, 3);
	Word = new Array("ВЕКТОРНОГО", "РАСТРОВЫЕ", "РЕТУШИРОВАНИЕ", "КОЛЛАЖ", "ПИКСЕЛЬ", "МОДЕЛИРОВАНИЕ", "ГРАФИКА", "ПРИМИТИВЫ", "НАУЧНОЕ", "КОД");
	Clue = new Array("Графические файлы ... типа имеют относительно небольшие размеры.", 
"Такие графические редакторы называют программамми \"картинного стиля\".", 
"Используя ... можно убрать с изображения повреждения, а также лишние детали.", 
"С помощью растрового редактора можно создать ..., в котором объединяются фрагменты различных изображений.", 
"Элемент рисунка.", 
"Создание трёхмерного объекта.", 
"Компьютерная ... - раздел информатики, занимающийся проблемами создания и обработки на компьютере графических изображений.", 
"Графические ... - совокупность простых элементов: прямых линий, дуг, окружностей, эллипсов, прямоугольников, закрасок и др..", 
"Самое первое направление графики.", 
"Информация о цвете пикселя.");
	AnswerHash = new Array(21334, 48426, 15925, 51196, 46165, 5599, 92889, 89303, 42612, 71333);
	WordX = new Array(1, 0, 2, 4, 7, 8, 13, 2, 11, 5);
	WordY = new Array(1, 3, 6, 9, 11, 0, 2, 5, 5, 8);
